...
[^1]: The assumption is that Moutai's brand power will enable it to have above GDP-level pricing power (4% price growth and 1% volume growth long-term in terminal value calculation).
...
{% include figure.liquid path="assets/img/baijiu_production_volume_chart.png" class="img-fluid rounded z-depth-1" caption="Baijiu Production Volume (1985–2025)" %}
