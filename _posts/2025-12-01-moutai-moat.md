...
1. When production volume and quality are in conflict, quality comes first.
2. When the speed of expansion and quality are in conflict, quality comes first.
3. When workload and quality are in conflict, quality comes first.
4. When cost and quality are in conflict, quality comes first.
...
{% include figure.liquid path="assets/img/moutai_town.png" class="img-fluid rounded z-depth-1" caption="The town of Moutai, Guizhou Province" %}
